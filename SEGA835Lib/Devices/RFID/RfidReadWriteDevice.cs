...
namespace Haruka.Arcade.SEGA835Lib.Devices.RFID {
    ...
    public abstract class RfidReadWriteDevice : Device {
        ...
        /// </summary>
        public RfidBackend Backend { get; }

        /// <summary>
        /// Creates a new RFID device.
        /// </summary>
        /// <param name="backend">The backend being used.</param>
        protected RfidReadWriteDevice(RfidBackend backend) {
        ...
        /// <see cref="DeviceStatus.ErrorPayloadTooLarge"/> if the payload is larger than 253 bytes.<br />
        ...
        /// <param name="subCmd">The sub command that was received.</param>
        ...
        protected DeviceStatus Read(out byte cmd, out byte subCmd, out byte[] payload) {
