...
namespace Haruka.Arcade.SEGA835Lib.Devices.Printer.CHC.C310 {
    unsafe partial class NativeB : INativeTrampolineChc {
        private static readonly ILogger LOG = LogManager.GetOrCreate(typeof(NativeB));
        ...
        private static partial int chcusb_imageformat(ushort format, ushort ncomp, ushort depth, ushort width, ushort height, byte* image, ref ushort rResult);
        ...
        private static partial int chcusb_commCardRfidReader(byte* sendData, byte* rRecvData, uint sendSize, ref uint rRecvSize, ref ushort rResult);
        ...
        private static partial int chcusb_updateCardRfidReader(byte* data, uint size, ref ushort rResult);
        ...
        public int CHC_imageformat(ushort format, ushort ncomp, ushort depth, ushort width, ushort height, byte* image, ref ushort rResult) {
            ...
            return chcusb_imageformat(format, ncomp, depth, width, height, image, ref rResult);
        }
        ...
        public int CHC_commCardRfidReader(byte* sendData, byte* rRecvData, uint sendSize, ref uint rRecvSize, ref ushort rResult) {
            LOG.LogDebugWithSource(LogExtensions.Arguments(sendSize));
            return chcusb_commCardRfidReader(sendData, rRecvData, sendSize, ref rRecvSize, ref rResult);
        }

        public int CHC_updateCardRfidReader(byte* data, uint size, ref ushort rResult) {
            LOG.LogDebugWithSource(LogExtensions.Arguments(size));
            return chcusb_updateCardRfidReader(data, size, ref rResult);
        }
